...
namespace Heimseiten\ContaoCtaAtTheSideBundle\DependencyInjection;
...
/**
 * Class HeimseitenContaoCtaAtTheSideExtension
 */
class HeimseitenContaoCtaAtTheSideExtension extends Extension
{
